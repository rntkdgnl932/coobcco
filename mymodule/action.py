...
def go_haeje(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\haeje.png"
...
def go_jangchack(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\jangchack.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(825, 980, 950, 1030, cla, img)
    ...
    try:
        ...
        if ready_ == True:
            ...
            if result == False:
                ...
                # full_path = "c:\\coobcco\\imgs\\soongan_3.png"
                # img_array = np.fromfile(full_path, np.uint8)
                # img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                ...
                while isquick_ is False:
                    ...
                    if result_ == False:
                        ...
                        time.sleep(1)
                        full_path = "c:\\coobcco\\imgs\\soongan.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        imgs_ = imgs_set(560, 100, 950, 860, cla, img)
                        if imgs_ is None or imgs_ == False:
                            full_path = "c:\\coobcco\\imgs\\soongan_2.png"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                            imgs_ = imgs_set(560, 100, 950, 860, cla, img)
                            if imgs_ is None or imgs_ == False:
...
def go_boonhae(cla, story):
    try:
        ...
        if os.path.isfile(file_path9) == True:
            # 파일 읽기
            with open(file_path9, "r", encoding='UTF8') as file:
            ...
            for i in range(len(lines)):
                full_path = "c:\\coobcco\\item\\trash\\" + lines[i] + ".png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            ...
            while isBoonhae is False:
                ...
                if ready_ == True:
                    ...
                    # 분해하기
                    full_path = "c:\\coobcco\\imgs\\ilgwalboonhae.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set(560, 970, 720, 1030, cla, img)
                    if imgs_ is None or imgs_ == False:
                        print('일괄분해 안보여 다시..')
                        full_path = "c:\\coobcco\\imgs\\boonhae_cancle.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        ...
                        full_path = "c:\\coobcco\\imgs\\boonhae.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        ...
                        if imgs_ is None or imgs_ == False:
                            ...
                            if selected_item == True:
                                ...
                                if result == True:
                                    ...
                                    # time.sleep(random_int())
                            time.sleep(2)
                            full_path = "c:\\coobcco\\imgs\\boonhae2.png"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def go_post_check(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\post.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def go_alrim_boonhae(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\post_end.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(435, 380, 510, 425, cla, img)

        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\item_delete_1.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(435, 430, 510, 470, cla, img)

            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\item_delete_2.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(435, 430, 510, 470, cla, img)
...
def go_alrim_(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\alrim_3.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(200, 300, 800, 800, cla, img)
        ...
        full_path = "c:\\coobcco\\imgs\\maul_bbaln.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(200, 300, 800, 800, cla, img)
...
def go_alrim_yes(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\alrim_yes.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\coobcco\\imgs\\alrim_yes2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(200, 300, 800, 1030, cla, img, 0.85)
        if imgs_ is not None:
        ...
        full_path = "c:\\coobcco\\imgs\\alrim_yes3.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(200, 300, 800, 1030, cla, img, 0.85)
        if imgs_ is not None:
            ...
            x_ = imgs_.x
            y_ = imgs_.y
        full_path = "c:\\coobcco\\imgs\\alrim_yes4.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(200, 300, 800, 1030, cla, img, 0.85)
        if imgs_ is not None:
        ...
        full_path = "c:\\coobcco\\imgs\\alrim_yes5.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(200, 300, 800, 1030, cla, img, 0.85)
        if imgs_ is not None:
        ...
        full_path = "c:\\coobcco\\item\\item_open\\sayong.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(200, 300, 800, 1030, cla, img, 0.85)
        if imgs_ is not None:
        ...
        full_path = "c:\\coobcco\\imgs\\clean\\hwagin_1.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(200, 300, 800, 1030, cla, img, 0.85)
        if imgs_ is not None:
        ...
        full_path = "c:\\coobcco\\imgs\\maul_bbaln_3.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def go_quickslot(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\quickslot.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def go_quest_ing(cla):
    try:
        ...
        isQuest = False
        full_path = "c:\\coobcco\\imgs\\auto_quest.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(860, 860, 930, 910, cla, img)
        if imgs_ is None or imgs_ == False:
            print("quest 안보여")
            full_path = "c:\\coobcco\\imgs\\auto_quest_1.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(860, 860, 930, 910, cla, img)
            if imgs_ is None or imgs_ == False:
                print("quest 안보여2")
                full_path = "c:\\coobcco\\imgs\\grow\\auto_quest_1.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(860, 860, 930, 910, cla, img)
                if imgs_ is None or imgs_ == False:
                    print("quest 안보여3")
                    full_path = "c:\\coobcco\\imgs\\grow\\auto_quest_2.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set(860, 860, 930, 910, cla, img)
                    if imgs_ is None or imgs_ == False:
                        print("quest 안보여4")
                        full_path = "c:\\coobcco\\imgs\\grow\\auto_quest_3.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        imgs_ = imgs_set(860, 860, 930, 910, cla, img)
                        if imgs_ is None or imgs_ == False:
...
def go_mynumber_(cla):
    try:
        ...
        while isgonumber is False:
            full_path = "c:\\coobcco\\imgs\\clean\\setting.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def go_potion_off(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\potion_hp_set.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(725, 815, 770, 865, cla, img)

        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\potion_hp_set_2.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(725, 815, 770, 865, cla, img)
...
def go_collection_on(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\collection.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\coobcco\\imgs\\collection_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(800, 875, 870, 945, cla, img)
        if imgs_ is not None:
        ...
        full_path = "c:\\coobcco\\imgs\\collection_3.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(800, 875, 870, 945, cla, img)
        if imgs_ is not None:
...
def go_juljun(cla, story):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\juljun_1.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is None or imgs_ == False:
            print("juljun_1 안보여")
            full_path = "c:\\coobcco\\imgs\\juljun_2.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(200, 290, 700, 750, cla, img)
        ...
        while isPost_ is False:
            ...
            if result_post == False:
                ...
                if post_get_bloon != False:
                    full_path2 = "c:\\coobcco\\imgs\\post_get.png"
                    ...
                    if imgs_2 is not None:
                        print("계정 우편이 있다...1")
                        post_get = True
                    full_path2 = "c:\\coobcco\\imgs\\post_get_1.png"
                    img_array2 = np.fromfile(full_path2, np.uint8)
                    img2 = cv2.imdecode(img_array2, cv2.IMREAD_COLOR)
                    imgs_2 = imgs_set(820, 120, 950, 950, cla, img2)
                    if imgs_2 is not None:
                    ...
                    if post_get == True:
                        ...
                        while isPostGet is False:
                            full_path = "c:\\coobcco\\imgs\\post_get_ing.png"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                ...
                while isPostcon is False:
                    full_path = "c:\\coobcco\\imgs\\post_get2.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                ...
                while isPost_2 is False:
                    ...
                    full_path = "c:\\coobcco\\imgs\\post_get.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def game_settings(cla, data):
    try:
        ...
        if data == 'juljun':
            ...
            full_path = "c:\\coobcco\\imgs\\settings\\skill_4_8.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            ...
            time.sleep(1)
            # 아바타
            full_path = "c:\\coobcco\\imgs\\settings\\e_1.PNG"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def swim_out(cla, story):
    try:
        ...
        print(get_story)
        full_path = "c:\\coobcco\\imgs\\swim.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def now_hunting_is(data, cla):
    try:
        ...
        maul_ = False
        full_path = "c:\\coobcco\\imgs\\maul\\maul_mana.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is not None:
            print("maul_mana")
            maul_ = True
        full_path = "c:\\coobcco\\imgs\\maul\\yotoon.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(200, 70, 400, 130, cla, img)
        if imgs_ is not None:
            ...
            full_path = "c:\\coobcco\\imgs\\maul\\yotoon2.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(200, 70, 400, 130, cla, img)
            if imgs_ is not None:
                print("yotoon2")
                maul_ = True
        full_path = "c:\\coobcco\\imgs\\maul\\maul_nida.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(200, 70, 400, 130, cla, img)
        if imgs_ is not None:
        ...
        if maul_ == False:
            ...
            if cla_ing_ == 'maul' or cla_ing_ == 'grow' or myQuest_grow_result[2] == '요툰육성' or myQuest_grow_result[2] == '니다육성':
                ...
                while isgoldCheck is False:
                    full_path = "c:\\coobcco\\imgs\\gold_check.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
