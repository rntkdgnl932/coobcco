...
def go_maul_bosang(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\maul_bosang_2.png"
...
def maul_cou_(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\maul.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        cou_1 = 0
        cou_2 = 0
        full_path = "c:\\coobcco\\imgs\\maul_complete_get.png"  # '완료' 글자 갯수 파악
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        for list in pyautogui.locateAllOnScreen(img, region=(230 + plus, 120, 90, 480), confidence=0.7):
            ...
            cou_1 += 1
        print("cou_1", cou_)
        full_path = "c:\\coobcco\\imgs\\maul_soolockham.png"  # '수락함' 글자 갯수 파악
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            ...
            if click_start_ == 3 and start_num_ != end__:
                ...
                for i in range(len(datas)):
                    if start_num_ == end__:
                        ...
                        full_path = "c:\\coobcco\\imgs\\jangbi_in\\" + item_list[0] + ".png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def maul_mission_complete(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\maul_bosang_3.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\coobcco\\imgs\\maul_complete_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\coobcco\\imgs\\maul_complete_3.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\coobcco\\imgs\\maul_complete_4.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def maul_mission_ready(cla):
    try:
        ...
        while isMission_ is False:
            full_path = "c:\\coobcco\\imgs\\maul_complete_get.png"  # '완료' 글자 클릭 후 보상 받기 버튼...
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def maul_mission_start(cla):
    try:
        ...
        full_path = "c:\\coobcco\\imgs\\maul_soolockham.png"  # '수락함' 글자 파악
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is None or imgs_ == False:
            ...
            while isAllMonsterCancle is False:
                full_path = "c:\\coobcco\\imgs\\maul_all_monster.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                ...
                if imgs_ is not None:
                    ...
                    # 빠른 이동...
                    full_path = "c:\\coobcco\\imgs\\maul_bbaln_2.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    try:
        ...
        while isGiveUp is False:
            ...
            if imgs_ is None or imgs_ == False:
                ...
                click_pos_reg(imgs_.x, imgs_.y, cla)
                time.sleep(1)
                full_path = "c:\\coobcco\\imgs\\maul_give_up.png"  # '수락함' 글자 파악
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
