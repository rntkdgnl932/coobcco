...
def tuto_grow(cla):
    ...
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_attack_22.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(410, 830, 840, 920, cla, img)
    if imgs_ is not None:
    ...
    full_path = "c:\\coobcco\\imgs\\grow\\drag_.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(220, 930, 800, 1030, cla, img)
    if imgs_ is not None:
        ...
        if result_go_auto == True:
            ...
            while isBigPotion_3 is False:
                ...
                if result_go_world_yotoon == False:
                    ...
                    click_pos_2(429, 579, cla)
                    time.sleep(1)


                    full_path = "c:\\coobcco\\imgs\\grow\\yotoon_big_potion_1.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    ...
                    if imgs_ is not None:
                        ...
                        isBigPotion_3 = False
                        while isBigPotion_3 is False:
                            full_path = "c:\\coobcco\\imgs\\grow\\yotoon_big_potion_2.png"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        ...
                        isBigPotion_4 = False
                        while isBigPotion_4 is False:
                            full_path = "c:\\coobcco\\imgs\\grow\\yotoon_big_potion_3.png"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        ...
                        while isBigPotion_5 is False:
                            full_path = "c:\\coobcco\\imgs\\grow\\yotoon_big_potion_4.png"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def common_grow(cla):
    ...
    # skip
    print("Grow_skip")
    full_path = "c:\\coobcco\\imgs\\grow\\skip_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(850, 35, 950, 80, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\skip_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(850, 35, 950, 80, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\skip_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(850, 35, 950, 80, cla, img)
            if imgs_ is not None:
    ...
    # main_ing
    print("Grow_main_ing")
    full_path = "c:\\coobcco\\imgs\\grow\\main_ing_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(660, 100, 710, 150, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\main_ing_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(660, 100, 710, 150, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\main_ing_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(660, 100, 710, 150, cla, img)
            if imgs_ is not None:
                ...
                # free_move
                full_path = "c:\\coobcco\\imgs\\grow\\free_move_1.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    full_path = "c:\\coobcco\\imgs\\grow\\main_complete_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(660, 105, 710, 150, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\main_complete_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(660, 100, 710, 150, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\main_complete_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(660, 100, 710, 150, cla, img)
            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\grow\\main_complete_4.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(660, 100, 710, 150, cla, img)
                if imgs_ is None or imgs_ == False:
                    full_path = "c:\\coobcco\\imgs\\grow\\main_complete_5.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set(700, 125, 830, 155, cla, img)
                    if imgs_ is None:
                        full_path = "c:\\coobcco\\imgs\\grow\\main_complete_6.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        imgs_ = imgs_set(700, 125, 830, 155, cla, img)
                        if imgs_ is not None:
                            ...
                            full_path = "c:\\coobcco\\imgs\\grow\\auto.png"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                            imgs_ = imgs_set(870, 860, 930, 910, cla, img)
                            if imgs_ is None or imgs_ == False:
                                print("grow\\auto.png 안보여(grow\\auto.png)")
                                full_path = "c:\\coobcco\\imgs\\grow\\auto_2.png"
                                img_array = np.fromfile(full_path, np.uint8)
                                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                imgs_ = imgs_set(870, 860, 930, 910, cla, img)
                                if imgs_ is None or imgs_ == False:
                                    full_path = "c:\\coobcco\\imgs\\grow\\auto_3.png"
                                    img_array = np.fromfile(full_path, np.uint8)
                                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                    imgs_ = imgs_set(870, 860, 930, 910, cla, img)
                                    if imgs_ is not None:
    ...
    quest_checked = True
    # full_path = "c:\\coobcco\\imgs\\grow\\quest_checked_1.png"
    # img_array = np.fromfile(full_path, np.uint8)
    # img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # main_bosang
    print("Grow_bosang")
    full_path = "c:\\coobcco\\imgs\\grow\\main_bosang_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(620, 830, 770, 150, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\main_bosang_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(400, 380, 550, 500, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\main_bosang_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # main_bosang
    full_path = "c:\\coobcco\\imgs\\grow\\main_quest_soolock_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(400, 380, 550, 500, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\main_quest_soolock_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_story_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(860, 250, 950, 330, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_story_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(860, 250, 950, 330, cla, img)
        if imgs_ is not None:
...
def yotoon_grow(cla):
    ...
    # 맹독
    pyautogui.moveTo(960, 960)

    endmangdok = True
    full_path = "c:\\coobcco\\imgs\\grow\\mangdok_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set_(650, 90, 950, 170, cla, img, 0.85)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\mangdok_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(650, 90, 950, 170, cla, img, 0.85)
        if imgs_ is not None:
    ...
    if endmangdok == False:
        ...
        while endmangdok is False:
            full_path = "c:\\coobcco\\imgs\\grow\\mangdok_complete_1.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            ...
            if imgs_ is not None:
                ...
                full_path = "c:\\coobcco\\imgs\\grow\\mangdok_complete_2.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_quest_moglog
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_quest_moglog_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_quest_moglog
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_potion_click_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    full_path = "c:\\coobcco\\imgs\\grow\\grow_gabang.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    full_path = "c:\\coobcco\\imgs\\grow\\grow_menu.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(500, 40, 950, 300, cla, img)
    if imgs_ is not None:
    ...
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_gabang_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(610, 120, 950, 200, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_gabang_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(340, 130, 580, 210, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\tuto_gabang_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(270, 130, 580, 210, cla, img)
            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\grow\\tuto_gabang_4.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    print("# somopoom : 일회성")
    issomopoom = False
    full_path = "c:\\coobcco\\imgs\\grow\\somopoom_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(30, 30, 160, 90, cla, img)
    if imgs_ is not None:
        issomopoom = True
    full_path = "c:\\coobcco\\imgs\\grow\\somopoom_11.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(30, 30, 160, 90, cla, img)
    if imgs_ is not None:
    ...
    if issomopoom == True:
        ...
        time.sleep(random_int())
        full_path = "c:\\coobcco\\imgs\\grow\\somopoom_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_talgut 1~5
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_talgut_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(775, 120, 950, 175, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_talgut_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(730, 30, 950, 70, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\tuto_talgut_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(520, 75, 800, 130, cla, img)
            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\grow\\tuto_talgut_4.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(680, 900, 950, 940, cla, img)
                if imgs_ is None or imgs_ == False:
                    full_path = "c:\\coobcco\\imgs\\grow\\tuto_talgut_5.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_talgut 6~10
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_talgut_6.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(775, 120, 950, 175, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_talgut_7.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(730, 25, 950, 70, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\tuto_talgut_8.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(675, 80, 890, 120, cla, img)
            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\grow\\tuto_talgut_9.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(760, 880, 950, 950, cla, img)
                if imgs_ is None or imgs_ == False:
                    full_path = "c:\\coobcco\\imgs\\grow\\tuto_talgut_10.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_guihwan
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_guihwan_1a.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(70, 170, 400, 280, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_guihwan_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_skill
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(770, 120, 950, 165, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(600, 80, 790, 130, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(300, 140, 900, 500, cla, img)
            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_4.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(660, 110, 950, 150, cla, img)
                if imgs_ is None or imgs_ == False:
                    full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_5.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set(610, 110, 950, 190, cla, img)
                    if imgs_ is None or imgs_ == False:
                        full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_6.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        imgs_ = imgs_set(635, 200, 850, 250, cla, img)
                        if imgs_ is None or imgs_ == False:
                            full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_7.png"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                            imgs_ = imgs_set(640, 870, 950, 950, cla, img)
                            if imgs_ is None or imgs_ == False:
                                full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_8.png"
                                img_array = np.fromfile(full_path, np.uint8)
                                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                imgs_ = imgs_set(630, 80, 900, 160, cla, img)
                                if imgs_ is None or imgs_ == False:
                                    full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_9.png"
                                    img_array = np.fromfile(full_path, np.uint8)
                                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                    imgs_ = imgs_set(380, 220, 680, 300, cla, img)
                                    if imgs_ is None or imgs_ == False:
                                        full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_10.png"
                                        img_array = np.fromfile(full_path, np.uint8)
                                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                        imgs_ = imgs_set(740, 110, 950, 160, cla, img)
                                        if imgs_ is None or imgs_ == False:
                                            full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_11.png"
                                            img_array = np.fromfile(full_path, np.uint8)
                                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_3_a.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(500, 100, 950, 600, cla, img)
    if imgs_ is not None:
        click_pos_reg(imgs_.x, imgs_.y, cla)
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_skill_3_b.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(500, 100, 950, 600, cla, img)
    if imgs_ is not None:
    ...
    # tuto_skillbook
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_skillbook_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(315, 100, 730, 190, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_skillbook_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_gongjoong
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_gongjoong_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(450, 150, 950, 240, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_gongjoong_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_abata
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_abata_11.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_abata_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(200, 510, 360, 600, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_abata_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(730, 140, 880, 200, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\tuto_abata_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(380, 950, 560, 1010, cla, img)
            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\grow\\tuto_abata_4.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(730, 110, 950, 170, cla, img)
                if imgs_ is None or imgs_ == False:
                    full_path = "c:\\coobcco\\imgs\\grow\\tuto_abata_5.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set(700, 210, 890, 270, cla, img)
                    if imgs_ is None or imgs_ == False:
                        full_path = "c:\\coobcco\\imgs\\grow\\tuto_abata_6.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        imgs_ = imgs_set(510, 260, 770, 350, cla, img)
                        if imgs_ is None or imgs_ == False:
                            full_path = "c:\\coobcco\\imgs\\grow\\tuto_abata_7.png"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                            imgs_ = imgs_set(760, 870, 950, 960, cla, img)
                            if imgs_ is None or imgs_ == False:
                                full_path = "c:\\coobcco\\imgs\\grow\\tuto_abata_8.png"
                                img_array = np.fromfile(full_path, np.uint8)
                                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_boonhae
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_boonhae_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(740, 120, 950, 170, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_boonhae_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(750, 120, 950, 190, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\tuto_boonhae_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(200, 120, 590, 200, cla, img)
            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\grow\\tuto_boonhae_4.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(0, 670, 240, 710, cla, img)
                if imgs_ is None or imgs_ == False:
                    full_path = "c:\\coobcco\\imgs\\grow\\tuto_boonhae_5.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set(630, 620, 940, 700, cla, img)
                    if imgs_ is None or imgs_ == False:
                        full_path = "c:\\coobcco\\imgs\\grow\\tuto_boonhae_6.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_jejak
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_jejak_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(800, 110, 950, 170, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_jejak_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(650, 280, 815, 330, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\tuto_jejak_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(170, 370, 450, 420, cla, img)
            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\grow\\tuto_jejak_4.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(430, 200, 710, 250, cla, img)
                if imgs_ is None or imgs_ == False:
                    full_path = "c:\\coobcco\\imgs\\grow\\tuto_jejak_5.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set(620, 850, 950, 930, cla, img)
                    if imgs_ is None or imgs_ == False:
                        full_path = "c:\\coobcco\\imgs\\grow\\tuto_jejak_6.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    ...
    # tuto_ganghwa
    full_path = "c:\\coobcco\\imgs\\grow\\tuto_ganghwa_1.png"
    img_array = np.fromfile(full_path, np.uint8)
    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
    imgs_ = imgs_set(690, 120, 950, 230, cla, img)
    if imgs_ is None or imgs_ == False:
        full_path = "c:\\coobcco\\imgs\\grow\\tuto_ganghwa_2.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(180, 130, 580, 210, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\tuto_ganghwa_3.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(200, 670, 380, 720, cla, img)
            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\grow\\tuto_ganghwa_4.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(480, 840, 770, 910, cla, img)
                if imgs_ is None or imgs_ == False:
                    full_path = "c:\\coobcco\\imgs\\grow\\tuto_ganghwa_5.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set(50, 870, 530, 950, cla, img)
                    if imgs_ is None or imgs_ == False:
                        full_path = "c:\\coobcco\\imgs\\grow\\tuto_ganghwa_6.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def yotoon_grow_end(cla):
    try:
        ...
        yotoon_end = False
        full_path = "c:\\coobcco\\imgs\\grow\\yotoon_end_1.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set(60, 110, 180, 160, cla, img)
        if imgs_ is None or imgs_ == False:
            full_path = "c:\\coobcco\\imgs\\grow\\yotoon_end_2.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(60, 110, 180, 160, cla, img)
            if imgs_ is None or imgs_ == False:
                full_path = "c:\\coobcco\\imgs\\grow\\yotoon_end_3.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(60, 110, 180, 160, cla, img)
                if imgs_ is None or imgs_ == False:
                    full_path = "c:\\coobcco\\imgs\\grow\\yotoon_end_4.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set(60, 110, 180, 160, cla, img)
                    if imgs_ is None or imgs_ == False:
                        full_path = "c:\\coobcco\\imgs\\grow\\yotoon_end_11.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        imgs_ = imgs_set(60, 110, 180, 160, cla, img)
                        if imgs_ is None or imgs_ == False:
        ...
        if yotoon_end == False:
            full_path = "c:\\coobcco\\imgs\\grow\\yotoon_end_22.png"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
            imgs_ = imgs_set(60, 110, 180, 160, cla, img)
            if imgs_ is not None and imgs_ == False:
                ...
                full_path = "c:\\coobcco\\imgs\\grow\\yotoon_end_33.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set(60, 110, 180, 160, cla, img)
                if imgs_ is not None and imgs_ == False:
...
def nida_grow_end(cla):
    try:
        ...
        endmangdok = True
        full_path = "c:\\coobcco\\imgs\\grow\\dongool.png"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
