...
def guild_list_(cla):
    try:
        ...
        if os.path.isfile(file_path10) == True:
            # 파일 읽기
            with open(file_path10, "r", encoding='UTF8') as file:
...
def guild_join_(cla):
    try:
        ...
        while isguild_ is False:
            full_path = "c:\\coobcco\\imgs\\guild\\guild.png"
            ...
            if imgs_ is not None and imgs_ != False:
                ...
                full_path = "c:\\coobcco\\imgs\\guild\\guild_lobby.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set_(20, 80, 330, 130, cla, img, 0.9)
                if imgs_ is not None and imgs_ != False:
                    guild_join_after = True
                full_path = "c:\\coobcco\\imgs\\guild\\guild_information.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set_(20, 80, 330, 130, cla, img, 0.9)
                if imgs_ is not None and imgs_ != False:
                ...
                if guild_join_after == True:
                    ...
                    while isbosang is False:
                        ...
                        time.sleep(1)
                        full_path = "c:\\coobcco\\imgs\\guild\\guild_bosang.png"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                ...
                ########################길드가입#############################################
                full_path = "c:\\coobcco\\imgs\\guild\\guild_join.png"
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                ...
                if imgs_ is not None and imgs_ != False:
                    ...
                    full_path = "c:\\coobcco\\imgs\\guild\\guild_moglog.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set_(20, 80, 330, 130, cla, img, 0.9)
                    if imgs_ is not None and imgs_ != False:
                        guild_join_before = True
                    full_path = "c:\\coobcco\\imgs\\guild\\guild_changsul.png"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set_(20, 80, 330, 130, cla, img, 0.9)
                    if imgs_ is not None and imgs_ != False:
